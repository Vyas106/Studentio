...
import { auth, db, doc, getDoc, signOut, updateDoc, storage, ref, 
         uploadBytes, getDownloadURL, deleteObject } from "@/lib/firebase";
...
// import { db } from "./firebaseConfig"; // Ensure you import the Firestore instance correctly
